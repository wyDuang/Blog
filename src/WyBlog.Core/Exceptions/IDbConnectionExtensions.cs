...
using WyBlog.Core.Models.CodeGenerateModel;
...
namespace WyBlog.Core.Exceptions
{
    ...
    public static class IDbConnectionExtensions
    {
        ...
        /// <returns></returns>
        public static List<DbTable> GetCurrentDatabaseTableList(this IDbConnection dbConnection, Models.DatabaseType dbType)
        {
        ...
        private static List<DbTable> GetCurrentDatabaseAllTables(this IDbConnection dbConnection, Models.DatabaseType dbType)
        {
        ...
        /// <returns></returns>
        private static List<DbTableColumn> GetColumnsByTableName(this IDbConnection dbConnection, Models.DatabaseType dbType, string tableName)
        {
            if (dbConnection == null) throw new ArgumentNullException(nameof(dbConnection));
            if (dbConnection.State == ConnectionState.Closed) dbConnection.Open();
        ...
        private static string strGetAllTablesSql(this IDbConnection dbConnection, Models.DatabaseType dbType)
        {
            string strGetAllTables = string.Empty;
            switch (dbType)
            {
                case Models.DatabaseType.SqlServer:
...
FROM      sys.syscolumns AS a LEFT OUTER JOIN
                ...
                case Models.DatabaseType.MySQL:
                    ...
                    break;
                case Models.DatabaseType.PostgreSQL:
                    strGetAllTables =
        ...
        private static string strGetAllColumnsSql(this IDbConnection dbConnection, Models.DatabaseType dbType, string tableName)
        {
